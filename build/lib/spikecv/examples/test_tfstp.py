...
def main(args=None):
    if args is None:
        ...
        parser.add_argument("--data_path", "-d", type=str, default="recVidarReal2019/classA/car-100kmh", help="Path to spike data")
    ...
    paraDict = data_parameter_dict(args.data_path, "raw")
    pprint(paraDict)
    ...
    filename_parts = path.split_path_into_pieces(args.data_path)
    result_video = (RESULTS_DIR / (filename_parts[-1] + '_tfstp.avi')).as_posix()
